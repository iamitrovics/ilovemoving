	...
	function understrap_setup() {
		...
		register_nav_menus(
			array(
				...
				'footer-links-1' => __( 'Footer Links 1', 'understrap' ),
				'footer-links-2' => __( 'Footer Links 2', 'understrap' ),
				'footer-links-3' => __( 'Footer Links 3', 'understrap' ),
				'footer-links-4' => __( 'Footer Links 4', 'understrap' ),
			)
		);
